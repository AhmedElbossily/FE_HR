...
extern float_t top_surface;
extern float_t global_die_velocity;
extern float_t global_wz;

void interactions_setup_geometry_constants(grid_base *g);

void interactions_monaghan(particle_gpu *particles, const int *cell_start, const int *cell_end, int num_cell, int s);
...
void interactions_ni_smoothing(particle_gpu *particles, const int *cells_start, const int *cells_end, int num_cell, float3_t *sum_buff, int *count_buff, int s);
void interactions_free_surface_detection(particle_gpu *particles, const int *cells_start, const int *cells_end, int num_cell, int s);
...
void interactions_setup_thermal_constants_substrate(trml_constants trml);
void interactions_setup_thermal_constants_rod(trml_constants trml, tool_3d_gpu *tool);
void interactions_setup_rod_constants(rod_constants rod_h);

void interactions_substrate_force_fraser(particle_gpu *particles, const int *cells_start, const int *cells_end, int num_cell);
void interactions_rod_force_Songwon(particle_gpu *particles, const int *cells_start, const int *cells_end, int num_cell, int *joined_count, float_t *joined_mean, float3 *forces);

void interactions_setup_johnson_cook_constants(joco_constants joco_sub, joco_constants joco_rod);

void interactions_calculate_force_die(particle_gpu *particles, const int *cells_start, const int *cells_end, int num_cell, int *joined_count, float_t *joined_mean, float3 *forces);
