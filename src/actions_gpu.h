...
void actions_setup_rod_constants(rod_constants rod);
void actions_setup_johnson_cook_constants(joco_constants joco_sub, joco_constants joco_rod);
void actions_setup_johnson_cook_constants(joco_constants joco_sub);
void actions_setup_physical_constants(phys_constants phys);
void actions_setup_corrector_constants(corr_constants corr);
void actions_setup_thermal_constants_substrate(trml_constants thrm);
void actions_setup_thermal_constants_rod(trml_constants thrm);
...
// Boundaries
void calculate_center_of_mass(particle_gpu *particles, int s);
