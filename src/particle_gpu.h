...
struct particle_gpu {
	...
	float4_t *vel = 0;  // forth chanel will be used for saving internal energy 
	float4_t *vel_bc = 0;
	...
	particle_gpu(float4_t *pos, float4_t *vel_init, float_t *rho, float_t *T_init, float_t *h, float_t *fixed, float_t *tool_p, unsigned int N, float_t* cp, float_t* H, float_t*k);
